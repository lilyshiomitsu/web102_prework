...
const displayStr = 
    'A total of ' + raisedCard.textContent + ' has been raised for ' + totalGames + ' games. Currently, ' + unfundedCount
...
const { name, desc, pledged, goal, backers, img } = firstGame

// create a new element to hold the name of the top pledge game, then append it to the correct element
const firstGameElement = document.createElement("p");
firstGameElement.textContent = name;
